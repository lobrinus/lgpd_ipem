...
# Junta as páginas conforme login
...
# Importa e executa a página correspondente
if paginas[pagina_escolhida] == "home_conteudo":
    with open("home_conteudo.py", "r", encoding="utf-8") as f:
        exec(f.read(), globals())
else:
